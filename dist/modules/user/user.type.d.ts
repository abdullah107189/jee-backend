...
export declare const PUBLIC_USER_SELECT: {
    id: true;
    email: true;
    phone: true;
    firstName: true;
 ...
 */
export type CreateUserInput = Omit<Prisma.UserUncheckedCreateInput, "id" | "createdAt" | "updatedAt" | "lastLogin" | "deletedAt" | "admin" | "seller" | "customer" | "notifications" | "auditLogs" | "activityLogs">;
