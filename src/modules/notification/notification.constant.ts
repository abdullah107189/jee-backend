...
export const NOTIFICATION_TYPES: readonly NotificationType[] = ["ORDER", "WARRANTY", "SALE", "SYSTEM", "PROMOTION"];
export const NOTIFICATION_CHANNELS: readonly NotificationChannel[] = ["EMAIL", "SMS", "PUSH", "IN_APP"];
