...
export function validateCreateProductInput(data: unknown): ValidationResult<CreateProductInput> {
  ...
  if (body.isPublished !== undefined && !isBoolean(body.isPublished)) errors.push("isPublished must be a boolean");
  ...
  return pass({
    ...
    warrantyMonths: body.warrantyMonths !== undefined ? (body.warrantyMonths as number) : undefined,
    ...
    categoryId: body.categoryId !== undefined && body.categoryId !== null ? (body.categoryId as string) : undefined,
    brandId: body.brandId !== undefined && body.brandId !== null ? (body.brandId as string) : undefined,
  });
}

export function validateUpdateProductInput(data: unknown): ValidationResult<Prisma.ProductUpdateInput> {
  if (typeof data !== "object" || data === null) return fail(["Request body must be an object"]);
  const body = data as Record<string, unknown>;
  const errors: string[] = [];
  ...
  if (body.specifications !== undefined) input.specifications = parseJson(body.specifications) as Prisma.InputJsonValue;
  if (body.warrantyMonths !== undefined) input.warrantyMonths = body.warrantyMonths as number;
  if (body.warrantyTerms !== undefined) input.warrantyTerms = body.warrantyTerms === null ? null : String(body.warrantyTerms);
  if (body.isPublished !== undefined) input.isPublished = toBoolean(body.isPublished);
...
export function validateCreateVariantInput(data: unknown): ValidationResult<CreateVariantInput> {
  if (typeof data !== "object" || data === null) return fail(["Request body must be an object"]);
  const body = data as Record<string, unknown>;
  const errors: string[] = [];

  if (typeof body.sku !== "string" || body.sku.trim() === "") errors.push("SKU is required");
  ...
  if (attributes === undefined || !isPlainObject(attributes)) errors.push("Attributes must be a valid JSON object");
  ...
  if (body.isDefault !== undefined && !isBoolean(body.isDefault)) errors.push("isDefault must be a boolean");
  ...
  return pass({
    ...
    comparePrice: body.comparePrice !== undefined && body.comparePrice !== null ? (body.comparePrice as number) : undefined,
    ...
    lowStockThreshold: body.lowStockThreshold !== undefined ? (body.lowStockThreshold as number) : undefined,
    isActive: body.isActive !== undefined ? toBoolean(body.isActive) : undefined,
  });
}

export function validateUpdateVariantInput(data: unknown): ValidationResult<Prisma.ProductVariantUpdateInput> {
  if (typeof data !== "object" || data === null) return fail(["Request body must be an object"]);
  const body = data as Record<string, unknown>;
  const errors: string[] = [];
  ...
  if (body.attributes !== undefined) input.attributes = parseJson(body.attributes) as Prisma.InputJsonValue;
  if (body.price !== undefined) input.price = body.price as number;
  if (body.comparePrice !== undefined) input.comparePrice = body.comparePrice === null ? null : (body.comparePrice as number);
  ...
  if (body.lowStockThreshold !== undefined) input.lowStockThreshold = body.lowStockThreshold as number;
  if (body.isActive !== undefined) input.isActive = toBoolean(body.isActive);
...
export function validateCreateItemInput(data: unknown): ValidationResult<CreateItemInput> {
  if (typeof data !== "object" || data === null) return fail(["Request body must be an object"]);
  const body = data as Record<string, unknown>;
  const errors: string[] = [];

  if (typeof body.uniqueId !== "string" || body.uniqueId.trim() === "") errors.push("uniqueId is required");
  if (body.status !== undefined && !(PRODUCT_ITEM_STATUSES as readonly string[]).includes(body.status as string)) {
  ...
  return pass({
    ...
    status: body.status !== undefined ? (body.status as ProductItemStatus) : undefined,
    metadata: parseJson(body.metadata),
    manufacturedAt: body.manufacturedAt !== undefined && body.manufacturedAt !== null ? new Date(body.manufacturedAt as string) : undefined,
  });
}

export function validateUpdateItemInput(data: unknown): ValidationResult<Prisma.ProductItemUpdateInput> {
  if (typeof data !== "object" || data === null) return fail(["Request body must be an object"]);
  const body = data as Record<string, unknown>;
  const errors: string[] = [];
  ...
  if (body.serialNumber !== undefined) input.serialNumber = body.serialNumber === null ? null : String(body.serialNumber);
  if (body.status !== undefined) input.status = body.status as ProductItemStatus;
  if (body.metadata !== undefined) input.metadata = parseJson(body.metadata) as Prisma.InputJsonValue;
  if (body.manufacturedAt !== undefined && body.manufacturedAt !== null) input.manufacturedAt = new Date(body.manufacturedAt as string);
